...
public class SendCodeUtil {
	...
	static final String accessKeyId = "LTAIT3aOiX0YJxRs";
	static final String accessKeySecret = "uhqw7VWG3SKkDDDrYOIJeCEKlHQoUl";
	static final String signName = "名智会";
	static final String templateCode = "SMS_154575113"; //SMS_155856516

	public static SendSmsResponse sendSms(String phone,String name, String code)
	...
	public static void main(String[] args) throws ClientException,
		  ...
		  sendSms("18226196958","liu","123456");
		/*
